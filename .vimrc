...
function! CompileCoffeeAndCompressJs()
    exec '!coffee -cb %'
    "    exec '!uglifyjs %<.js -o %<.js'
endfunction
autocmd BufWritePost *.coffee silent call CompileCoffeeAndCompressJs()
...
" 多个ctags匹配，列出所有的：http://www.cnblogs.com/lomper/p/6935696.html
map <c-]> g<c-]>
